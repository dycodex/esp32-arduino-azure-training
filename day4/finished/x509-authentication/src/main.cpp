...
void setup()
{
    ...
    else
    {
        ...
        IoTHubDeviceClient_LL_SetOption(device_ll_handle, OPTION_X509_CERT, my_device_certs);
        IoTHubDeviceClient_LL_SetOption(device_ll_handle, OPTION_X509_PRIVATE_KEY, my_device_private_key);
